...
### 代码规范
- 所有 public 类/接口/方法必须写 JavaDoc 注释
- 关键业务逻辑、复杂算法、非显而易见的处理必须写行内注释（说明"为什么"而非"怎么做"）
- 禁止魔法数字，业务状态使用枚举，其他数值使用常量
- Entity ↔ DTO/VO 转换使用 setter 赋值或 BeanUtils.copyProperties，禁止构造器转换
- 一致的命名规范
- 合理的异常处理
- 清晰的代码结构
